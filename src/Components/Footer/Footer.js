  ...
  return (
    <footer className="footer">
      <div className="footer__navbox">
        <nav className="footer__nav">
          <div className="footer__navgroup">
            ...
            <Link to="/localpicks" className="footer__link">
            ...
            {/* <Link to={`${ontarioURL}`} className="footer__link">
              ONTARIO
            </Link>
            <Link to={`${floridaURL}`} className="footer__link">
              FLORIDA
            </Link> */}
            <Link to="/featured" className="footer__link footer__link--desktop">
              FEATURED LISTINGS
            </Link>
          </div>
          <div className="footer__navgroup footer__navgroup--tablet">
            ...
            <Link to="/featured" className="footer__link">
              FEATURED LISTINGS
            </Link>
      ...
      <div className="footer__bar">
        <p className="footer__bartext">
          © 2021 by Julian Arcila Real Estate Group. All rights reserved.
        </p>
      </div>
    </footer>
  );
